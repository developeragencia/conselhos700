// Script para gerar ícones PWA simples em SVG
const fs = require('fs');
...
fs.writeFileSync('tarot-shortcut.svg', shortcutSvg('🃏', '#8b5cf6'));
fs.writeFileSync('astro-shortcut.svg', shortcutSvg('⭐', '#06b6d4'));
fs.writeFileSync('dashboard-shortcut.svg', shortcutSvg('📊', '#10b981'));
